  ...
  const translations = {
		EN: {
			titelPath1: "OWN THE GAME",
			titelPath2: "OR MISS THE FAME!",
			textPath1: "WEFT is your VIP pass",
			textPath2: "to the wild world of GambleFi!",
			btnRegistration: "Join sale",
			discriptionPath1: "WEFT TOKEN SALE 2.0",
			discriptionPath2: "drops",
			discriptionPath3: "11.11.2025",
			modalTitlePath1: "OWN THE GAME ",
			modalTitlePath2: "OR MISS THE ",
			modalTitlePath3: "FAME!",
			labelEmail: "Email*",
		...
		HU: {
			titelPath1: "URALD A JÁTÉKOT",
			titelPath2: "VAGY MARADJ LE A HÍRNÉVRŐL!",
			textPath1: "WEFT is your VIP pass",
			textPath2: "to the wild world of GambleFi!",
			btnRegistration: "Csatlakozz az akcióhoz",
			discriptionPath1: "WEFT TOKEN SALE 2.0",
			discriptionPath2: "2025. 11. 11-én",
			discriptionPath3: "indul",
			modalTitlePath1: "URALD A JÁTÉKOT ",
			modalTitlePath2: "VAGY MARADJ LE A ",
			modalTitlePath3: "HÍRNÉVRŐL!",
			labelEmail: "Email*",
			placeholderEmail: "Email",
		...
		PT: {
			titelPath1: "DOMINA O JOGO",
			titelPath2: "OU PERDE A FAMA!",
			textPath1: "WEFT is your VIP pass",
			textPath2: "to the wild world of GambleFi!",
			btnRegistration: "Participar na promoção",
			discriptionPath1: "VENDA DE TOKENS WEFT 2.0",
			discriptionPath2: "drops",
			discriptionPath3: "11.11.2025",
			modalTitlePath1: "DOMINA O JOGO ",
			modalTitlePath2: "OU PERDE A ",
			modalTitlePath3: "FAMA!",
			labelEmail: "Email*",
			placeholderEmail: "Email",
			labelPassword: "Senha*",
		...
		RU: {
			titelPath1: "ВЛАДЕЙТЕ ИГРОЙ",
			titelPath2: "ИЛИ ОСТАНЬТЕСЬ В ТЕНИ!",
			textPath1: "WEFT is your VIP pass",
			textPath2: "to the wild world of GambleFi!",
			btnRegistration: "Присоединиться к распродаже",
			discriptionPath1: "WEFT TOKEN SALE 2.0",
			discriptionPath2: "стартует",
			discriptionPath3: "11.11.2025",
			modalTitlePath1: "ВЛАДЕЙТЕ ИГРОЙ ",
			modalTitlePath2: "ИЛИ ОСТАНЬТЕСЬ ",
			modalTitlePath3: "В ТЕНИ!",
			labelEmail: "Email*",
			placeholderEmail: "Email",
		...
		CZ: {
			titelPath1: "VLASTNÍ HRU",
			titelPath2: "NEBO ZMEŠKEJTE SLÁVU!",
			textPath1: "WEFT is your VIP pass",
			textPath2: "to the wild world of GambleFi!",
			btnRegistration: "Připojit se k výprodeji",
			discriptionPath1: "WEFT TOKEN SALE 2.0",
			discriptionPath2: "začíná",
			discriptionPath3: "11.11.2025",
			modalTitlePath1: "VLASTNÍ HRU",
			modalTitlePath2: "NEBO ZMEŠKEJTE ",
			modalTitlePath3: "SLÁVU!",
			labelEmail: "Email*",
			placeholderEmail: "Email",
			labelPassword: "Heslo*",
		...
		CA: {
			titelPath1: "PRENEZ LE CONTRÔLE DU JEU",
			titelPath2: "OU MANQUEZ LA RENOMMÉE!",
			textPath1: "WEFT is your VIP pass",
			textPath2: "to the wild world of GambleFi!",
			btnRegistration: "Participer à la vente",
			discriptionPath1: "VENTE DE JETONS WEFT 2.0",
			discriptionPath2: "débute",
			discriptionPath3: "le 2025-11-11",
			modalTitlePath1: "PRENEZ LE CONTRÔLE DU JEU ",
			modalTitlePath2: "OU MANQUEZ LA ",
			modalTitlePath3: "RENOMMÉE!",
			labelEmail: "Courriel*",
			placeholderEmail: "Adresse courriel",
			labelPassword: "Mot de passe*",
			placeholderPassword: "Mot de passe",
			checkbox:
				"En cochant cette case pour vous inscrire sur ce site, vous déclarez avoir plus de 18 ans et avoir lu, compris et accepté",
			terms: "les Conditions générales d’utilisation",
			modalBtn: "Créer un compte",
			quantityCharacter: "Contenir au moins 6 caractères",
			uppercaseCharacter: "Inclure au moins 1 lettre majuscule",
			numberCharacter: "Inclure au moins 1 chiffre",
			emailError: "Format de courriel incorrect",
		},
	};
