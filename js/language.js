  ...
  const translations = {
		EN: {
			...
			modalTitlePath2: "OR MISS THE FAME!",
			modalTitlePath3: "",
			labelEmail: "Email*",
		...
		PT: {
			...
			modalTitlePath2: "OU PERDE A FAMA!",
			modalTitlePath3: "",
			labelEmail: "Email*",
			placeholderEmail: "Email",
			labelPassword: "Senha*",
		...
		CA: {
			...
			modalTitlePath1: "PRENEZ LE CONTRÔLE ",
			modalTitlePath2: "DU JEU OU MANQUEZ ",
			modalTitlePath3: "LA RENOMMÉE!",
			labelEmail: "Courriel*",
