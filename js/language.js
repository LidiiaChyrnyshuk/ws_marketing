  ...
  const translations = {
		EN: {
			titelPath1: "TOKEN SALE 2.0",
			titelPath2: "THE WAIT IS OVER!",
			btnRegistration: "Join sale",
			discriptionPath1: "GET YOUR TOKENS ",
			discriptionPath3: "Now!",
		...
		HU: {
			titelPath1: "TOKEN SALE 2.0",
			titelPath2: "A VÁRAKOZÁS VÉGE!",
			btnRegistration: "Csatlakozz az akcióhoz",
			discriptionPath1: "SZEREZZ BE TOKENEKET",
			discriptionPath3: "MOST!",
		...
		PT: {
			titelPath1: "TOKEN SALE 2.0",
			titelPath2: "A ESPERA ACABOU!",
			btnRegistration: "Participar na promoção",
			discriptionPath1: "ADQUIRA TOKENS",
			discriptionPath3: "AGORA!",
		...
		RU: {
			titelPath1: "TOKEN SALE 2.0",
			titelPath2: "ОЖИДАНИЕ ЗАВЕРШЕНО!",
			btnRegistration: "Присоединиться к распродаже",
			discriptionPath1: "ПОЛУЧИТЕ ТОКЕНЫ",
			discriptionPath3: "СЕЙЧАС!",
		...
		CZ: {
			titelPath1: "TOKEN SALE 2.0",
			titelPath2: "ČEKÁNÍ SKONČILO!",
			btnRegistration: "Připojit se k výprodeji",
			discriptionPath1: "ZÍSKEJTE TOKENY HNED",
			discriptionPath3: "TEĎ!",
		...
		CA: {
			titelPath1: "TOKEN SALE 2.0",
			titelPath2: "L'ATTENTE EST TERMINÉE!",
			btnRegistration: "Participer à la vente",
			discriptionPath1: "OBTENEZ VOS TOKENS DÈS",
			discriptionPath3: "MAINTENANT!",
